 ...
 */
/**
 * Standard energy report. Holds all usage values and formatted output.
 */
public class Report {
    ...
    public Report(String applianceName,
                  double dailyUsage,
                  double weeklyUsage,
                  double monthlyUsage,
                  String tip,
    ...
    public String printReport() {
        ...
        double score = Math.max(0, 10 - (diff * 2));
